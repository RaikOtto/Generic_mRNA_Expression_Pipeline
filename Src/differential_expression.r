...
results = decideTests(fit, lfc = 3, p.value = 0.01)
summary(results)
colnames(result_summary) <- "NETvsNormal"
topall = topTable( fit, coef = "contrast", number  = nrow( eDatSet ), adjust  ="none", p.value = 0.01, lfc = 3)
