...
dir.create( paste( cel_files_path, "Output", sep = "/"), showWarnings = F )
...
quality_report_path         = paste( cel_files_path, "Output/QC_report" , sep = "/" )
results_file_path           = paste( cel_files_path, "Output", paste( "Results", project_name, sep ="_"), sep = "/" )
name_res_file               = paste( results_file_path, paste( "dif_exp_results", "csv", sep ="."), sep = "/" )
pathway_maps_path           = paste( cel_files_path, "Output", paste( "Results", project_name, sep ="_")  , "pathway_maps_dif_exp", sep ="/" )
...
entities_of_interest_path   = paste( cel_files_path, "Output", paste( "Results", project_name, sep ="_")  , "Entities_of_interest", sep ="/")
